...
if __name__ == "__main__":
    ...
    parallelProcessJoblib(1, (2*365*24*60), (0*60), datetime.strptime("2022-07-24 09:19:00", "%Y-%m-%d %H:%M:%S"), False, 2)
    #parallelProcessJoblib(5, (2*365*24*60), (0*60), datetime.strptime("2022-07-24 09:19:00", "%Y-%m-%d %H:%M:%S"), False, 1.2)
